<?php
    ...
    if ($status === 'sucesso') {
        $modalTitulo = 'Sucesso!';
        $modalMensagem = 'Todas as predefinições foram importadas.';
        ...
        $modalMensagem = 'Nenhum dado foi salvo. O arquivo contém erros de formatação ou valores inválidos.';
    }
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Finance Control - Importar Predefinições</title>
    ...
    <div class="modal-page-wrap wide">
        <div class="dialog-inner">
            ...
            <div class="notice-box">
                <strong class="notice-title">⚠️ Atenção aos requisitos das predefinições</strong>
                <ul>
                ...
                <code>Tipo;Descrição;Valor;Categoria</code>
                <ul>
            ...
            <form method="POST" action="processar_importacao_predefinicoes" enctype="multipart/form-data">
                ...
                <div class="dialog-actions">
                    ...
                    <button type="submit" class="btn-primary">Importar predefinições</button>
                </div>
            </form>
        </div>
    </div>
